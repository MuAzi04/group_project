...
public class Power {
	...
	public Power(GameScreen gameScreen) {
		...
		this.body = BodyHelper.createCircularBody(x, y, radius, BodyType.DynamicBody, 0.1f, gameScreen.getWorld(), ContactType.POWER);
		
		// Applies an initial force to start the ball movement
		body.applyForceToCenter(getInitialVelocityVector(), false);
	}

    public void updateType(PowerType newtype){
        this.type = newtype;
    }
